...
HD_PWD='D:/A_Rada_V1.1/A_Rada_V1.1/A_Rada_V1.1.runs/system_TOP_0_10_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_TOP_0_10.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_TOP_0_10.tcl
