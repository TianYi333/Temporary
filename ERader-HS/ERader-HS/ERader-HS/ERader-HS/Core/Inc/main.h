...
#define MOTION HAL_GPIO_ReadPin(TIM8_CH4_GPIO_Port,TIM8_CH4_Pin)==GPIO_PIN_RESET//运动
#define CEASE  HAL_GPIO_ReadPin(TIM8_CH4_GPIO_Port,TIM8_CH4_Pin)==GPIO_PIN_SET//停止

#define DO_MOTION HAL_GPIO_WritePin(TIM8_CH4_GPIO_Port,TIM8_CH4_Pin,GPIO_PIN_RESET)//PA7-使运动
#define DO_CEASE  HAL_GPIO_WritePin(TIM8_CH4_GPIO_Port,TIM8_CH4_Pin,GPIO_PIN_SET)//PA7-使停止

#define COROTATION HAL_GPIO_ReadPin(TIM8_CH3_GPIO_Port,TIM8_CH3_Pin)==GPIO_PIN_SET//正转
#define REVERSAL   HAL_GPIO_ReadPin(TIM8_CH3_GPIO_Port,TIM8_CH3_Pin)==GPIO_PIN_RESET//反转

#define DO_RADAR_ON  HAL_GPIO_WritePin(TIM8_CH2_GPIO_Port,TIM8_CH2_Pin,GPIO_PIN_SET)//PC8-使雷达上电
#define DO_RADAR_OFF HAL_GPIO_WritePin(TIM8_CH2_GPIO_Port,TIM8_CH2_Pin,GPIO_PIN_RESET)//PC8-使雷达断电

#define RADAR_ON  HAL_GPIO_ReadPin(TIM8_CH2_GPIO_Port,TIM8_CH2_Pin)==GPIO_PIN_SET//雷达上电
#define RADAR_OFF HAL_GPIO_ReadPin(TIM8_CH2_GPIO_Port,TIM8_CH2_Pin)==GPIO_PIN_RESET//雷达断电
...
#define MOTOR_SPEED_RERATIO 1	//电机减速比
