...
#define Subtraction 5000	//细分数(或输出多少个脉冲旋转一圈)
#define Subtraction_2 (Subtraction/1000)	//细分数的千分之一
...
#define MOTION HAL_GPIO_ReadPin(TIM8_CH1N_GPIO_Port,TIM8_CH1N_Pin)==GPIO_PIN_RESET//运动
#define CEASE  HAL_GPIO_ReadPin(TIM8_CH1N_GPIO_Port,TIM8_CH1N_Pin)==GPIO_PIN_SET//停止

#define DO_MOTION HAL_GPIO_WritePin(TIM8_CH1N_GPIO_Port,TIM8_CH1N_Pin,GPIO_PIN_RESET)//PA7-使运动
#define DO_CEASE  HAL_GPIO_WritePin(TIM8_CH1N_GPIO_Port,TIM8_CH1N_Pin,GPIO_PIN_SET)//PA7-使停止
...
#define DO_Servo_Reset  		HAL_GPIO_WritePin(TIM8_CH2N_GPIO_Port,TIM8_CH2N_Pin,GPIO_PIN_RESET)//PC8-伺服复位（低电平复位）
#define DO_Servo_Reset_OFF 	HAL_GPIO_WritePin(TIM8_CH2N_GPIO_Port,TIM8_CH2N_Pin,GPIO_PIN_SET)//PC8-伺服复位关
