...
void TTC_test(void)
{
	if(XGpioPs_ReadPin(&gpiops_inst, AM2302_1_SDA)==0)
	{
		XGpioPs_WritePin(&gpiops_inst, AM2302_1_SDA, 1);
	}
	else if(XGpioPs_ReadPin(&gpiops_inst, AM2302_1_SDA)==1)
	{
		XGpioPs_WritePin(&gpiops_inst, AM2302_1_SDA, 0);
	}
}
