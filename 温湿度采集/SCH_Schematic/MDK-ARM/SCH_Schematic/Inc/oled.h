...
#define OLED_SCLK_Clr() HAL_GPIO_WritePin(GPIOC,GPIO_PIN_0,GPIO_PIN_RESET)//SCL  拉低
#define OLED_SCLK_Set() HAL_GPIO_WritePin(GPIOC,GPIO_PIN_0,GPIO_PIN_SET)  //SCL  拉高
 
#define OLED_SDIN_Clr() HAL_GPIO_WritePin(GPIOC,GPIO_PIN_1,GPIO_PIN_RESET)//SDA  拉低
#define OLED_SDIN_Set() HAL_GPIO_WritePin(GPIOC,GPIO_PIN_1,GPIO_PIN_SET)  //SDA  拉高
